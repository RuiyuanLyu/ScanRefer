...
# data
CONF.SCANNET_DIR =  "/mnt/hwfile/OpenRobotLab/maoxiaohan/transfer/ScanNet_v2/scans" 
CONF.SCANNET_FRAMES_ROOT = "/mnt/hwfile/OpenRobotLab/maoxiaohan/transfer/ScanNet_v2/posed_images" # TODO change this
